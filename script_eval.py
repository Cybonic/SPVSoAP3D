...
chkpt_root = 'l/home/tiago/workspace/SPCoV/code/v3/checkpoints/iros24_ablation/cross_validation-nonorm-10m-aug-noroi/triplet/ground_truth_ar0.5m_nr10m_pr2m.pkl/10000/greenhouse-e3-extracted/SPVSoAP3D-SoAP-log-pn-fc-LazyTripletLoss_L2/best_model.pth'

save_path = '~/workspace/SPCoV/predictions'

test_sequences = [
        f'--val_set GTJ23  --resume {chkpt_root}',
